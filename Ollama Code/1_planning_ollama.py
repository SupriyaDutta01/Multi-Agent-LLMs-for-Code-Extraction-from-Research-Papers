...
responses = []
trajectories = []
stages = [plan_msg, file_list_msg, task_list_msg, config_msg]
stage_names = [
    "[Planning] Overall plan",
    "[Planning] Architecture design",
    "[Planning] Logic design",
    "[Planning] Configuration file generation"
]

for idx, msg in enumerate(stages):
    print(stage_names[idx])
    trajectories.extend(msg)
    reply = run_llm(trajectories)
    print(reply)
...
with open(os.path.join(output_dir, 'planning_response.json'), 'w') as f:
