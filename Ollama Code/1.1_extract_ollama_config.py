...
save_dir="/home/supriyo/Desktop/Project"
os.makedirs(save_dir, exist_ok=True)

with open(f"{save_dir}/arch_design.txt","w") as f:
    f.write(json.dumps(arch_design, indent=2))


with open(f"{save_dir}/logic_design.txt","w") as f:
    f.write(json.dumps(logic_design, indent=2))
